    ...
    <div className="container section" style={{ paddingBottom: 'var(--space-3xl)' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '3rem', marginBottom: '4rem' }}>
        ...
        <div style={{ flex: '1 1 400px', display: 'flex', flexDirection: 'column' }}>
          ...
          <button 
            className="btn" 
            style={{ width: '100%', marginBottom: '2rem', backgroundColor: '#25D366', color: 'white', borderColor: '#25D366', fontSize: '1.0625rem', gap: '0.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
            onClick={(e) => {
              e.preventDefault();
              import('../../utils/whatsapp').then(({ getWhatsAppLink }) => {
                const url = getWhatsAppLink({ type: 'product', data: product });
