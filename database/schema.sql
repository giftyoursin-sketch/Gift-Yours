...
CREATE TABLE IF NOT EXISTS products (
  ...
  designer_cost NUMERIC DEFAULT 0,
  print_lamination_default_price NUMERIC DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS sales (
  ...
  designer_items JSONB DEFAULT '[]',
  print_lamination_items JSONB DEFAULT '[]',
  designer_cost_total NUMERIC DEFAULT 0,
  print_lamination_total NUMERIC DEFAULT 0,
